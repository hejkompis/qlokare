...
if ( ! defined( 'CLEAN_JOURNAL_THEME_VERSION' ) ) {
	...
	$wp_customize->add_panel( 'clean_journal_theme_options', array(
	    'description'    => __( 'Basic theme Options', 'clean-journal' ),
	    'capability'     => 'edit_theme_options',
	    'priority'       => 200,
	    'title'    		 => __( 'Theme Options', 'clean-journal' ),
	) );


	// Breadcrumb Option
	$wp_customize->add_section( 'clean_journal_breadcumb_options', array(
		'description'	=> __( 'Breadcrumbs are a great way of letting your visitors find out where they are on your site with just a glance. You can enable/disable them on homepage and entire site.', 'clean-journal' ),
		'panel'			=> 'clean_journal_theme_options',
		'title'    		=> __( 'Breadcrumb Options', 'clean-journal' ),
		'priority' 		=> 201,
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[breadcumb_option]', array(
		'label'    => __( 'Check to enable Breadcrumb', 'clean-journal' ),
	...
	$wp_customize->add_control( 'clean_journal_theme_options[breadcumb_onhomepage]', array(
		'label'    => __( 'Check to enable Breadcrumb on Homepage', 'clean-journal' ),
		'section'  => 'clean_journal_breadcumb_options',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[breadcumb_seperator]', array(
            ...
            'label'    	=> __( 'Separator between Breadcrumbs', 'clean-journal' ),
			'section' 	=> 'clean_journal_breadcumb_options',
	...
	$wp_customize->add_section( 'clean_journal_custom_css', array(
		'description'	=> __( 'Custom/Inline CSS', 'clean-journal'),
		'panel'  		=> 'clean_journal_theme_options',
		'priority' 		=> 203,
		'title'    		=> __( 'Custom CSS Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[custom_css]', array(
			'label'		=> __( 'Enter Custom CSS', 'clean-journal' ),
	        'priority'	=> 1,
	...
	$wp_customize->add_section( 'clean_journal_excerpt_options', array(
		'panel'  	=> 'clean_journal_theme_options',
		'priority' 	=> 204,
		'title'    	=> __( 'Excerpt Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[excerpt_length]', array(
		'description' => __('Excerpt length. Default is 55 words', 'clean-journal'),
		'input_attrs' => array(
            'min'   => 10,
            'max'   => 200,
            'step'  => 5,
        ...
        'label'    => __( 'Excerpt Length (words)', 'clean-journal' ),
	...
	$wp_customize->add_control( 'clean_journal_theme_options[excerpt_more_text]', array(
		'label'    => __( 'Read More Text', 'clean-journal' ),
		'section'  => 'clean_journal_excerpt_options',
	...
	$wp_customize->add_section( 'clean_journal_homepage_options', array(
		'description'	=> __( 'Only posts that belong to the categories selected here will be displayed on the front page', 'clean-journal' ),
		'panel'			=> 'clean_journal_theme_options',
		'priority' 		=> 209,
		'title'   	 	=> __( 'Homepage / Frontpage Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( new Clean_Journal_Customize_Dropdown_Categories_Control( $wp_customize, 'clean_journal_theme_options[front_page_category]', array(
        'label'   	=> __( 'Select Categories', 'clean-journal' ),
	...
	// Icon Options
	$wp_customize->add_section( 'clean_journal_icons', array(
		'description'	=> __( 'Remove Icon images to disable.', 'clean-journal'),
		'panel'  => 'clean_journal_theme_options',
		'priority' 		=> 210,
		'title'    		=> __( 'Icon Options', 'clean-journal' ),
	) );

	$wp_customize->add_setting( 'clean_journal_theme_options[favicon]', array(
		'capability'		=> 'edit_theme_options',
		'sanitize_callback'	=> 'clean_journal_sanitize_image',
	) );

	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'clean_journal_theme_options[favicon]', array(
		'label'		=> __( 'Select/Add Favicon', 'clean-journal' ),
		'section'    => 'clean_journal_icons',
        'settings'   => 'clean_journal_theme_options[favicon]',
	) ) );

	$wp_customize->add_setting( 'clean_journal_theme_options[web_clip]', array(
		'capability'		=> 'edit_theme_options',
		'sanitize_callback'	=> 'clean_journal_sanitize_image',
	) );

	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'clean_journal_theme_options[web_clip]', array(
		'description'	=> __( 'Web Clip Icon for Apple devices. Recommended Size - Width 144px and Height 144px height, which will support High Resolution Devices like iPad Retina.', 'clean-journal'),
		'label'		 	=> __( 'Select/Add Web Clip Icon', 'clean-journal' ),
		'section'    	=> 'clean_journal_icons',
        'settings'   	=> 'clean_journal_theme_options[web_clip]',
	) ) );
	// Icon Options End
	...
	$wp_customize->add_section( 'clean_journal_layout', array(
		...
		'panel'		=> 'clean_journal_theme_options',
		'priority'	=> 211,
		'title'		=> __( 'Layout Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[theme_layout]', array(
		'choices'	=> $choices,
		'label'		=> __( 'Default Layout', 'clean-journal' ),
	...
	$layouts = clean_journal_get_archive_content_layout();
	$choices = array();
	foreach ( $layouts as $layout ) {
		$choices[ $layout['value'] ] = $layout['label'];
	}
	...
	$wp_customize->add_control( 'clean_journal_theme_options[content_layout]', array(
		'choices'   => $choices,
		'label'		=> __( 'Archive Content Layout', 'clean-journal' ),
		'section'   => 'clean_journal_layout',
	...
	$single_post_image_layouts = clean_journal_single_post_image_layout_options();
	$choices = array();
	...
	$wp_customize->add_control( 'clean_journal_theme_options[single_post_image_layout]', array(
			'label'		=> __( 'Single Page/Post Image Layout ', 'clean-journal' ),
			'section'   => 'clean_journal_layout',
	...
	*/
	...
	$wp_customize->add_section( 'clean_journal_pagination_options', array(
		...
		'panel'  		=> 'clean_journal_theme_options',
		'priority'		=> 212,
		'title'    		=> __( 'Pagination Options', 'clean-journal' ),
	) );
	...
	$pagination_types = clean_journal_get_pagination_types();
	$choices = array();
	...
	$wp_customize->add_control( 'clean_journal_theme_options[pagination_type]', array(
		'choices'  => $choices,
		'label'    => __( 'Pagination type', 'clean-journal' ),
    ...
    $wp_customize->add_section( 'clean_journal_promotion_headline_options', array(
		'description'	=> __( 'To disable the fields, simply leave them empty.', 'clean-journal' ),
		'panel'			=> 'clean_journal_theme_options',
		'priority' 		=> 213,
		'title'   	 	=> __( 'Promotion Headline Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[promotion_headline_option]', array(
		'choices'  	=> $choices,
		'label'    	=> __( 'Enable Promotion Headline on', 'clean-journal' ),
		'priority'	=> '0.5',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[promotion_headline]', array(
		'description'	=> __( 'Appropriate Words: 10', 'clean-journal' ),
		'label'    	=> __( 'Promotion Headline Text', 'clean-journal' ),
		'priority'	=> '1',
		'section' 	=> 'clean_journal_promotion_headline_options',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[promotion_subheadline]', array(
		'description'	=> __( 'Appropriate Words: 15', 'clean-journal' ),
		'label'    	=> __( 'Promotion Subheadline Text', 'clean-journal' ),
		'priority'	=> '2',
		'section' 	=> 'clean_journal_promotion_headline_options',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[promotion_headline_button]', array(
		'description'	=> __( 'Appropriate Words: 3', 'clean-journal' ),
		'label'    	=> __( 'Promotion Headline Button Text ', 'clean-journal' ),
		'priority'	=> '3',
		'section' 	=> 'clean_journal_promotion_headline_options',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[promotion_headline_url]', array(
		'label'    	=> __( 'Promotion Headline Link', 'clean-journal' ),
		'priority'	=> '4',
		'section' 	=> 'clean_journal_promotion_headline_options',
	...
	$wp_customize->add_control( 'clean_journal_theme_options[promotion_headline_target]', array(
		'label'    	=> __( 'Check to Open Link in New Window/Tab', 'clean-journal' ),
		'priority'	=> '5',
		'section'  	=> 'clean_journal_promotion_headline_options',
	...
	$wp_customize->add_section( 'clean_journal_scrollup', array(
		'panel'    => 'clean_journal_theme_options',
		'priority' => 215,
		'title'    => __( 'Scrollup Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[disable_scrollup]', array(
		'label'		=> __( 'Check to disable Scroll Up', 'clean-journal' ),
	...
	$wp_customize->add_section( 'clean_journal_search_options', array(
		'description'=> __( 'Change default placeholder text in Search.', 'clean-journal'),
		'panel'  => 'clean_journal_theme_options',
		'priority' => 216,
		'title'    => __( 'Search Options', 'clean-journal' ),
	) );
	...
	$wp_customize->add_control( 'clean_journal_theme_options[search_text]', array(
		'label'		=> __( 'Default Display Text in Search', 'clean-journal' ),
