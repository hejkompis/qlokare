 ...
 * @since Clean Journal 0.1
 */
function clean_journal_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Clean Journal 0.1
 */
function clean_journal_sanitize_custom_css( $input ) {
	if ( $input != '' ) { 
 ...
 */
function clean_journal_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Clean Journal 0.1
 */
function clean_journal_sanitize_page( $input ) {
 ...
 * @since Clean Journal 0.1
 */
function clean_journal_sanitize_category_list( $input ) {
	if ( $input != '' ) { 
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function clean_journal_sanitize_number_range( $number, $setting ) {
 ...
 * @since Clean Journal 0.1
 */
function clean_journal_sanitize_footer_code( $input ) {
 ...
 */
function clean_journal_sanitize_select( $input, $setting ) {
 ...
 * @since Clean Journal 0.1
 */
function clean_journal_reset_all_settings( $input ) {
	if ( $input == 1 ) {
        // Set default values
 ...
 * @since Clean Journal 0.1
 */
function clean_journal_sanitize_important_link() {
	return false;
} 
