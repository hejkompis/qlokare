...
function clean_journal_get_default_theme_options() {
	...
	$default_theme_options = array(
		...
		//Excerpt Options
		'excerpt_length'									=> '55',
		'excerpt_more_text'									=> __( 'Read More ...', 'clean-journal' ),
		...
		'promotion_headline'								=> __( 'Clean Journal is a Premium Responsive WordPress Theme', 'clean-journal' ),
		'promotion_subheadline'								=> __( 'This is promotion headline. You can edit this from Appearance -> Customize -> Theme Options -> Promotion Headline Options', 'clean-journal' ),
		'promotion_headline_button'							=> __( 'Reviews', 'clean-journal' ),
		'promotion_headline_url'							=> esc_url( 'http://wordpress.org/support/view/theme-reviews/journal' ),
		'promotion_headline_target'							=> 1,

		//Search Options
		'search_text'										=> __( 'Search...', 'clean-journal' ),
		...
		'featured_content_headline'							=> __( 'Featured Content', 'clean-journal' ),
		'featured_content_subheadline'						=> __( 'Here you can showcase the x number of Featured Content.', 'clean-journal' ),
...
function clean_journal_color_schemes() {
	$color_scheme_options = array(
		'light' => array(
			'value' 				=> 'light',
			'label' 				=> __( 'Light', 'clean-journal' ),
		),
		'dark' => array(
			'value' 				=> 'dark',
			'label' 				=> __( 'Dark', 'clean-journal' ),
		),
	);
...
function clean_journal_layouts() {
	$layout_options = array(
		'left-sidebar' 	=> array(
			'value' => 'left-sidebar',
			'label' => __( 'Primary Sidebar, Content', 'clean-journal' ),
		),
		'right-sidebar' => array(
			'value' => 'right-sidebar',
			'label' => __( 'Content, Primary Sidebar', 'clean-journal' ),
		),
		'no-sidebar'	=> array(
			'value' => 'no-sidebar',
			'label' => __( 'No Sidebar ( Content Width )', 'clean-journal' ),
		),
	);
...
function clean_journal_get_archive_content_layout() {
	$layout_options = array(
		'excerpt-image-left' => array(
			...
			'label' => __( 'Show Excerpt', 'clean-journal' ),
		),
		'full-content' => array(
			'value' => 'full-content',
			'label' => __( 'Show Full Content (No Featured Image)', 'clean-journal' ),
		),
	);
...
function clean_journal_enable_featured_header_image_options() {
	$enable_featured_header_image_options = array(
		'homepage' 		=> array(
			'value'	=> 'homepage',
			'label' => __( 'Homepage / Frontpage', 'clean-journal' ),
		),
		'exclude-home' 		=> array(
			'value'	=> 'exclude-home',
			'label' => __( 'Excluding Homepage', 'clean-journal' ),
		),
		'exclude-home-page-post' 	=> array(
			'value' => 'exclude-home-page-post',
			'label' => __( 'Excluding Homepage, Page/Post Featured Image', 'clean-journal' ),
		),
		'entire-site' 	=> array(
			'value' => 'entire-site',
			'label' => __( 'Entire Site', 'clean-journal' ),
		),
		'entire-site-page-post' 	=> array(
			'value' => 'entire-site-page-post',
			'label' => __( 'Entire Site, Page/Post Featured Image', 'clean-journal' ),
		),
		'pages-posts' 	=> array(
			'value' => 'pages-posts',
			'label' => __( 'Pages and Posts', 'clean-journal' ),
		),
		'disabled'		=> array(
			'value' => 'disabled',
			'label' => __( 'Disabled', 'clean-journal' ),
		),
	);
...
function clean_journal_featured_image_size_options() {
	$featured_image_size_options = array(
		'full' 		=> array(
			'value'	=> 'full',
			'label' => __( 'Full Image', 'clean-journal' ),
		),
		'large' 	=> array(
			'value' => 'large',
			'label' => __( 'Large Image', 'clean-journal' ),
		),
		'slider'		=> array(
			'value' => 'slider',
			'label' => __( 'Slider Image', 'clean-journal' ),
		),
	);
...
function clean_journal_featured_content_types() {
	$featured_content_types = array(
		'demo-featured-content' => array(
			...
			'label' => __( 'Demo Featured Content', 'clean-journal' ),
		),
		'featured-page-content' => array(
			'value' => 'featured-page-content',
			'label' => __( 'Featured Page Content', 'clean-journal' ),
		)
	);
...
function clean_journal_featured_content_layout_options() {
	$featured_content_layout_option = array(
		'layout-three' 		=> array(
			'value'	=> 'layout-three',
			'label' => __( '3 columns', 'clean-journal' ),
		),
		'layout-four' 	=> array(
			'value' => 'layout-four',
			'label' => __( '4 columns', 'clean-journal' ),
		),
	);
...
function clean_journal_featured_content_show() {
	$featured_content_show_option = array(
		...
		'full-content' 	=> array(
			'value' => 'full-content',
			'label' => __( 'Show Full Content', 'clean-journal' ),
		),
		'hide-content' 	=> array(
			'value' => 'hide-content',
			'label' => __( 'Hide Content', 'clean-journal' ),
		),
	);
...
function clean_journal_featured_slider_types() {
	$featured_slider_types = array(
		'demo-featured-slider' => array(
			...
			'label' => __( 'Demo Featured Slider', 'clean-journal' ),
		),
		'featured-page-slider' => array(
			'value' => 'featured-page-slider',
			'label' => __( 'Featured Page Slider', 'clean-journal' ),
		),
	);
...
function clean_journal_featured_slide_transition_effects() {
	$featured_slide_transition_effects = array(
		'fade' 		=> array(
			'value'	=> 'fade',
			'label' => __( 'Fade', 'clean-journal' ),
		),
		'fadeout' 	=> array(
			'value'	=> 'fadeout',
			'label' => __( 'Fade Out', 'clean-journal' ),
		),
		'none' 		=> array(
			'value' => 'none',
			'label' => __( 'None', 'clean-journal' ),
		),
		'scrollHorz'=> array(
			'value' => 'scrollHorz',
			'label' => __( 'Scroll Horizontal', 'clean-journal' ),
		),
		'scrollVert'=> array(
			'value' => 'scrollVert',
			'label' => __( 'Scroll Vertical', 'clean-journal' ),
		),
		'flipHorz'	=> array(
			'value' => 'flipHorz',
			'label' => __( 'Flip Horizontal', 'clean-journal' ),
		),
		'flipVert'	=> array(
			'value' => 'flipVert',
			'label' => __( 'Flip Vertical', 'clean-journal' ),
		),
		'tileSlide'	=> array(
			'value' => 'tileSlide',
			'label' => __( 'Tile Slide', 'clean-journal' ),
		),
		'tileBlind'	=> array(
			'value' => 'tileBlind',
			'label' => __( 'Tile Blind', 'clean-journal' ),
		),
		'shuffle'	=> array(
			'value' => 'shuffle',
			'label' => __( 'Suffle', 'clean-journal' ),
		)
	);
...
function clean_journal_featured_slider_image_loader() {
	$color_scheme_options = array(
		'true' => array(
			'value' 				=> 'true',
			'label' 				=> __( 'True', 'clean-journal' ),
		),
		'wait' => array(
			'value' 				=> 'wait',
			'label' 				=> __( 'Wait', 'clean-journal' ),
		),
		'false' => array(
			'value' 				=> 'false',
			'label' 				=> __( 'False', 'clean-journal' ),
		),
	);
...
function clean_journal_get_pagination_types() {
	$pagination_types = array(
		'default' => array(
			'value' => 'default',
			'label' => __( 'Default(Older Posts/Newer Posts)', 'clean-journal' ),
		),
		'numeric' => array(
			'value' => 'numeric',
			'label' => __( 'Numeric', 'clean-journal' ),
		),
		'infinite-scroll-click' => array(
			'value' => 'infinite-scroll-click',
			'label' => __( 'Infinite Scroll (Click)', 'clean-journal' ),
		),
		'infinite-scroll-scroll' => array(
			'value' => 'infinite-scroll-scroll',
			'label' => __( 'Infinite Scroll (Scroll)', 'clean-journal' ),
		),
	);
...
function clean_journal_single_post_image_layout_options() {
	$single_post_image_layout_options = array(
		'featured' => array(
			'value' => 'featured',
			'label' => __( 'Featured', 'clean-journal' ),
		),
		'full-size' => array(
			'value' => 'full-size',
			'label' => __( 'Full Size', 'clean-journal' ),
		),
		'disabled' => array(
			'value' => 'disabled',
			'label' => __( 'Disabled', 'clean-journal' ),
...
function clean_journal_metabox_layouts() {
	$layout_options = array(
		'default' 	=> array(
			...
			'value' => 'default',
			'label' => __( 'Default', 'clean-journal' ),
		),
		'left-sidebar' 	=> array(
			'id' 	=> 'clean-journallayout-option',
			'value' => 'left-sidebar',
...
function clean_journal_metabox_header_featured_image_options() {
	$header_featured_image_options = array(
		...
		'enable' => array(
			'id'		=> 'clean-journalheader-image',
			'value' 	=> 'enable',
			'label' 	=> __( 'Enable', 'clean-journal' ),
		),
		'disable' => array(
			'id'		=> 'clean-journalheader-image',
			'value' 	=> 'disable',
			'label' 	=> __( 'Disable', 'clean-journal' )
		)
	);
...
function clean_journal_metabox_featured_image_options() {
	$featured_image_options = array(
		...
		'featured' => array(
			'id'		=> 'clean-journalfeatured-image',
			'value' 	=> 'featured',
			'label' 	=> __( 'Featured Image', 'clean-journal' )
		),
		'full-size' => array(
			'id' => 'clean-journalfeatured-image',
			'value' => 'full-size',
		...
		'disable' => array(
			'id' => 'clean-journalfeatured-image',
			'value' => 'disable',
			'label' => __( 'Disable Image', 'clean-journal' )
		)
	);
...
function clean_journal_get_content() {
	...
	$clean_journal_content['left'] 	= sprintf( _x( 'Copyright &copy; %1$s %2$s. All Rights Reserved.', '1: Year, 2: Site Title with home URL', 'clean-journal' ), date( 'Y' ), '<a href="'. esc_url( home_url( '/' ) ) .'">'. esc_attr( get_bloginfo( 'name', 'display' ) ) . '</a>' );
