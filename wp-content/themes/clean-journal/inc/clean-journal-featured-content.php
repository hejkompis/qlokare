					...
					<div class="wrapper">';
						if ( !empty( $headline ) || !empty( $subheadline ) ) {
							$clean_journal_featured_content .='<div class="featured-heading-wrap">';
								if ( !empty( $headline ) ) {
									$clean_journal_featured_content .='<h1 id="featured-heading" class="entry-title">'. $headline .'</h1>';
								}
								if ( !empty( $subheadline ) ) {
									$clean_journal_featured_content .='<p>'. $subheadline .'</p>';
								}
						...
						<div class="featured-content-wrap">';
							...
							// Select content
							if ( $contentselect == 'demo-featured-content'  && function_exists( 'clean_journal_demo_content' ) ) {
								$clean_journal_featured_content .= clean_journal_demo_content( $options );
							}
							elseif ( $contentselect == 'featured-page-content' && function_exists( 'clean_journal_page_content' ) ) {
...
function clean_journal_demo_content( $options ) {
	$clean_journal_demo_content = '
		<article id="featured-post-1" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="Central Park" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured1-350x263.jpg" />
			</figure>
		...
		<article id="featured-post-2" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="Home Office" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured2-350x263.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
		...
		<article id="featured-post-3" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="Vespa Scooter" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured3-350x263.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
	...
	if( 'layout-four' == $options ['featured_content_layout'] || 'layout-two' == $options ['featured_content_layout'] ) {
		...
		<article id="featured-post-4" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="Antique Clock" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured4-350x263.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
...
function clean_journal_page_content( $options ) {
	...
	if ( !empty( $page_list ) && $number_of_page > 0 ) {
		...
		while ( $get_featured_posts->have_posts()) : $get_featured_posts->the_post(); $i++;
			$title_attribute = the_title_attribute( array( 'before' => __( 'Permalink to: ', 'clean-journal' ), 'echo' => false ) );
			...
			$clean_journal_page_content .= '
				...
				if ( has_post_thumbnail() ) {
					...
					<figure class="featured-homepage-image">
						...
						'. get_the_post_thumbnail( $post->ID, 'clean-journal-featured-content', array( 'title' => esc_attr( $title_attribute ), 'alt' => esc_attr( $title_attribute ), 'class' => 'pngfix' ) ) .'
						</a>
					</figure>';
				}
				else {
					$clean_journal_first_image = clean_journal_get_first_image( $post->ID, 'clean-journal-featured-content', array( 'title' => esc_attr( $title_attribute ), 'alt' => esc_attr( $title_attribute ), 'class' => 'pngfix' ) );
				...
				$clean_journal_page_content .= '
					<div class="entry-container">
						...
						elseif ( 'full-content' == $show_content ) { 
							...
							$clean_journal_page_content .= '<div class="entry-content">' . $content . '</div><!-- .entry-content -->';
						}
					$clean_journal_page_content .= '
					</div><!-- .entry-container -->
