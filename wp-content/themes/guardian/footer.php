...
<div class="footer1">
	<div class="container">			
		...
		<div class="one_third animate" data-anim-type="fadeInUp">
			<div class="siteinfo">			
				<h4 class="lmb"><?php _e('About Guardian','weblizar'); ?></h4>				
				<p><?php _e('All the Lorem Ipsum generators on the Internet tend to repeat predefined an chunks as necessary, making this the first true generator on the Internet.
					All the Lorem Ipsum generators on the Internet tend to repeat predefined Lorem Ipsum as their default model text, and a search for web sites.','weblizar'); ?></p>
				<br />							
			</div>
		</div><!-- end site info -->	
		<div class="one_third animate" data-anim-type="fadeInUp">
			<div class="qlinks">		
				<h4 class="lmb"><?php _e('Custom Menu','weblizar'); ?></h4>			
				<ul>
					<li><a href="#"><?php _e('Home','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Blog','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Service','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Portfolio','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('About-us','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Team','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Contact -Us','weblizar'); ?></a></li>
				</ul>			
			</div>
		</div><!-- end links -->
		...
		<div class="one_third last animate" data-anim-type="fadeInUp">
			<div class="qlinks">		
				<h4 class="lmb"><?php _e('Recent Posts','weblizar'); ?></h4>			
				<ul>
					<li><a href="#"><?php _e('Awsome Slidershows','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Features and Typography','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Different &amp; Unique Pages','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Single and Portfolios','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Recent Blogs or News','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Post with Image','weblizar'); ?></a></li>
					<li><a href="#"><?php _e('Layered PSD Files','weblizar'); ?></a></li>
				</ul>			
			</div>
		</div><!-- end links 	-->	
...
<div class="copyright_info">
		<div class="container">
			...
			<div class="one_third">
			<a href="<?php echo esc_url( __( 'http://wordpress.org/', 'weblizar' ) ); ?>"><?php printf( __( 'Proudly powered by %s', 'weblizar' ), 'WordPress' ); ?></a>
			</div>
