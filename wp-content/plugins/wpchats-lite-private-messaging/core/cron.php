...
register_activation_hook( WPC_PLUGIN_FILE, function() {
...
register_deactivation_hook ( WPC_PLUGIN_FILE, function() {
	wp_unschedule_event( wp_next_scheduled( 'wpc_notify_mods' 			), 'wpc_notify_mods' 			);
	wp_unschedule_event( wp_next_scheduled( 'wpc_notify_mods_summaries' ), 'wpc_notify_mods_summaries' 	);
});
